...
module.exports = {
  ...
  promo: {
    ...
    image: metadata.images.banners + "1176x264-1xbet-es.png",
    carrouselBonus: {
  ...
  texts: {
    ...
    noNostrSigner: "No se detectó un signer NIP-07. Instala una extensión (p. ej. Alby) o pega tu nsec.",
    ...
    login: "Acceder",
    requireLogin: "Inicia sesión para acceder a tus beneficios",
